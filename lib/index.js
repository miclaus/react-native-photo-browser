...
export default class PhotoBrowser extends React.Component {
  ...
  static propTypes = {
    ...
    /*
     * Called when fullscreen mode changed
     */
    onFullscreenChanged: PropTypes.func,

    /*
     * Called when controls start to hide
     */
    onControlsDisplay: PropTypes.func,
  ...
  _toggleTopBar(displayed: boolean) {
    ...
    this.props.onControlsDisplay(displayed);
  }
  ...
  _toggleFullScreen(display: boolean) {
    ...
    this.props.onFullscreenChanged(display);
